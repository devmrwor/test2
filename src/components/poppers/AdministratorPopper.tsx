...
import { AdminRoutes, Routes, UserRoutes } from "../../../common/enums/api-routes";
...
interface AdministratorsPopperProps {
...
export const AdministratorsPopper = ({
  anchorEl,
  userId,
  isSingle,
  handleClose,
          ...
          <div className="flex flex-col w-53.5 py-2">
            {isSingle && (
              <>
                <Link
                  className="w-full"
                  href={uniteRoutes([Routes.USERS, UserRoutes.ADMINS, AdminRoutes.UPDATE, userId])}
                  passHref
                >
                  <button
                    type="button"
